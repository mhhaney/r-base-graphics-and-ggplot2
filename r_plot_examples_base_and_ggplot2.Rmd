...
<<<<<<< HEAD
>>>>>>> db7aaf23698122c3709bc65577c9d389006ba98c
=======
...
>>>>>>> 40b97696ee55ae5b148b88d8c59fa5e50204108a
## Density Curve
...
cardata <- as.data.frame(data(cars))
head(cars)
gg <- ggplot(cars, aes(x=speed, y=dist)) + 
  geom_point(aes(col=, size=popdensity)) + 
  geom_smooth(method="loess", se=F) + 
  xlim(c(0, 10)) + 
  ylim(c(0, 25)) + 
  labs(subtitle="Car Speed vs. Stopping Distance", 
       y="Stopping Distance", 
       x="Speed", 
