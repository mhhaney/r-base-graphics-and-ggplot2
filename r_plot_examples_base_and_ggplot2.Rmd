...
## Additional Pie Chart using Base R
...
pie(values, labels=lab, main = "Pittsburgh Schools", density = 10, 
...
ggplot() +
  ...
  coord_map()
```
### Two plots side-by-side - gridExtra Package - grid.arrange()

library(gridExtra)
library(ggplot2)

#I created my own random data here to use
