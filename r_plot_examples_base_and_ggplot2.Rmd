...
In this plot, we will see the type of vitamin c, either the viatmin itself, or orange juice versus the tooth length.
...
Using Age as the ransition to see how many points and Games Played per player. The larger the Bubble, the more Field Goals Made. Color represents Wins
