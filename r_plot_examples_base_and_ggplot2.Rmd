...
#### Use the same dataset, iris, to create a stripchart for the same variable, Sepal.Width
```{r}
ggplot(data = iris) + geom_jitter(aes(x=Sepal.Width, y=0, color='red'), width = 0.05, height = 0, alpha = 0.25)
```
