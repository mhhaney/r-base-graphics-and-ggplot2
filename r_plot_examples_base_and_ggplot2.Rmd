...
## Diverging Lollipop Chart
  Not sure if I did this correctly but initial attempt
```{R}
library(ggplot2)
...
ggplot(data, aes(x=x, y=y)) +
  geom_segment( aes(x=x, xend=x, y=.75, yend=y), color="black") +
  ...
  xlab("Student A-J") +
  ylab("Time spent studying 1.0 = 1 hour") +
  ggtitle("Student Hours of Studying") +
