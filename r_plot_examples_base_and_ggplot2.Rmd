...
### Strip Chart with NBA Data, Base R

Strip charts are particularly useful with small datasets. The NBA data has a small number of players per team, so let's try to replicate the comparisons shown in the violin plot section, but with strip charts.
