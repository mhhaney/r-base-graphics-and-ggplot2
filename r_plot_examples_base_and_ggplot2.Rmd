...
```{r}
hist(rivers,                                                
     main = "Length of Rivers in North America", col='blue', breaks=20, xlim=c(0, 4000), ylim=c(0, 80))
```

Using the Iris dataset, display a customized histogram for petal width.
...
Demonstrating a histogram with ggplot2 based on the following example:
